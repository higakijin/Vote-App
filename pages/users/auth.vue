      ...
      <section class="text-gray-600 body-font">
        <div class="container px-5 py-44 mx-auto flex flex-wrap items-center">
          <div class="lg:w-3/5 md:w-1/2 md:pr-16 lg:pr-0 pr-0">
            <h1 class="title-font font-medium text-3xl text-gray-900">VoteAppにログインしてあなたの疑問を世界中に聞いてみよう。</h1>
    ...
    <div v-if="!showLogin" class="signupForm">
      <section class="text-gray-600 body-font">
        <div class="container px-5 py-28 mx-auto flex flex-wrap items-center">
          <div class="lg:w-3/5 md:w-1/2 md:pr-16 lg:pr-0 pr-0">
            <h1 class="title-font font-medium text-3xl text-gray-900">ようこそ、VoteAppへ</h1>
            <p class="leading-relaxed mt-4">
              登録してあなたの疑問を解消しましょう。あなたの質問を求めている人がいます。
