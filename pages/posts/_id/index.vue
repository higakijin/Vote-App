        ...
        <div class="grid grid-cols-7">
          ...
          <div class="col-span-7 lg:col-span-1 xl:col-span-1 my-auto flex justify-end gap-x-5">
            ...
            <div v-show="!already_liked(post.likes)"  @click="like_post(post)" class="inline-block flex cursor-pointer">
              <svg class="w-7 h-7 my-auto" version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" xml:space="preserve">
                <style type="text/css">
                  .st0{fill:#4B4B4B;}
                </style>
                <g>
                  <path class="st0" d="M373.597,29.736c-0.938,0-1.856,0.009-2.795,0.03C313.675,30.864,276.726,59.028,256,93.182
                    ...
                    C441.605,299.833,408.54,328.815,371.391,357.748z" style="fill: rgb(75, 75, 75);"></path>
                </g>
              </svg>
